...
namespace net.esper.pattern
{
	...
	public sealed class EvalFollowedByNode : EvalNode
	{
												...
												Object stateNodeId )
		{
			...
			{
				throw new IllegalStateException( "Expected number of child nodes incorrect, expected >=2 child nodes, found " + ChildNodes.Count );
			}

			return context.PatternStateFactory.MakeFollowedByState(parentNode, this, beginState, stateNodeId);
		}
