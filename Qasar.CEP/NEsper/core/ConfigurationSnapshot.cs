...
namespace net.esper.core
{
	...
	public class ConfigurationSnapshot
	{
        ...
        private readonly ConfigurationEngineDefaults engineDefaults;
        private readonly EDictionary<String, Object> extensionConfigurations = new HashDictionary<String, Object>(); 
	    ...
	    public ConfigurationSnapshot(Configuration configuration)
	    {
	        ...
	        engineDefaults = configuration.EngineDefaults;
            extensionConfigurations.PutAll(configuration.ExtensionConfigs);
 }
        ...
        {
            get { return engineDefaults; }
        }

        /// <summary>
        /// Gets the extension module configuration objects per extension.
        /// </summary>
        /// <value>The extension configurations.</value>
        public EDictionary<String, Object> ExtensionConfigurations
        {
            get { return extensionConfigurations; }
        }
    }
}
