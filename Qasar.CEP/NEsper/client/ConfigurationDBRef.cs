...
namespace net.esper.client
{
    ...
    public class ConfigurationDBRef
    {
        ...
        virtual public ParameterStyle ParameterStyle
        {
            get { return parameterModel.Style; }
            set { parameterModel.Style = value; }
        }
        ...
        virtual public String ParameterPrefix
        {
            get { return parameterModel.Prefix; }
            set { parameterModel.Prefix = value; }
        }
    	...
    	{
        	connectionFactoryDesc = new DbProviderFactoryConnection(providerName, connectionArgs, parameterModel);
	    }
        ...
        {
            connectionFactoryDesc = new DbProviderFactoryConnection(settings, parameterModel);
        }
