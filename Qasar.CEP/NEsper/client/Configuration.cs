...
namespace net.esper.client
{
    ...
    public class Configuration : ConfigurationOperations
    {
        ...
        /// </summary>
        protected EDictionary<String, Object> extensionConfigurations;
        ...
        /// <param name="configurationObject">The extension configuration object.</param>
        public void AddExtensionConfig(String extensionName, Object configurationObject)
        {
            extensionConfigurations[extensionName] = configurationObject;
        }

        /// <summary>
        /// Returns extension configuration objects as a map of extension module name and
        /// configuration object.
        /// <returns>extension configuration objects</returns>
        /// </summary>
        public EDictionary<String, Object> ExtensionConfigs
        {
        ...
        internal void Reset()
        {
            ...
            extensionConfigurations = new HashDictionary<String, Object>();
        }
