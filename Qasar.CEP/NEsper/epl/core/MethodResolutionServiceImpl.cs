...
namespace com.espertech.esper.epl.core
{
    ...
    public class MethodResolutionServiceImpl : MethodResolutionService
	{
        ...
        public MethodInfo ResolveMethod(String typeNameAlias, String methodName)
        {
            return engineImportService.ResolveMethod(typeNameAlias, methodName);
	    }

        public Type ResolveClass(String typeNameAlias)
        {
            return engineImportService.ResolveType(typeNameAlias);
	    }

        public MethodInfo ResolveMethod(Type type, String methodName, Type[] paramTypes)
        {
            return engineImportService.ResolveMethod(type, methodName, paramTypes);
        }
        ...
        /// <returns>aggregator</returns>
        public AggregationMethod MakeDistinctAggregator(AggregationMethod aggregationMethod, Type childType)
        {
