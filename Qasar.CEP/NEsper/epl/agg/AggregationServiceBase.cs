...
namespace com.espertech.esper.epl.agg
{
	...
	public abstract class AggregationServiceBase : AggregationService
	{
		...
		public abstract void ApplyEnter(com.espertech.esper.events.EventBean[] eventsPerStream, com.espertech.esper.collection.MultiKeyUntyped optionalGroupKeyPerRow);
        /// <summary>
        ...
        /// <param name="optionalGroupKeyPerRow">can be null if grouping without keys is desired, else the keys
        /// to use for grouping, each distinct key value results in a new row of aggregation state.</param>
		public abstract void ApplyLeave(com.espertech.esper.events.EventBean[] eventsPerStream, com.espertech.esper.collection.MultiKeyUntyped optionalGroupKeyPerRow);
        /// <summary>
        /// Set the current aggregation state row - for use when evaluation nodes are asked to evaluate.
        /// </summary>
        /// <param name="groupKey">key identify the row of aggregation states</param>
		public abstract void SetCurrentRow(com.espertech.esper.collection.MultiKeyUntyped groupKey);
        /// <summary>
