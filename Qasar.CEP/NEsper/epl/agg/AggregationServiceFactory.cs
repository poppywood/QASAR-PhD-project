...
namespace com.espertech.esper.epl.agg
{
	...
	public class AggregationServiceFactory
	{
	                                                ...
	                                                MethodResolutionService methodResolutionService)
	    {
	        ...
	        LinkedHashMap<ExprAggregateNode, IList<ExprAggregateNode>> equivalencyList = new LinkedHashMap<ExprAggregateNode, IList<ExprAggregateNode>>();
	        ...
	        foreach (ExprAggregateNode aggregateNode in equivalencyList.Keys)
	        {
	            ...
	            IList<ExprAggregateNode> equivalentAggregators = equivalencyList.Get(aggregateNode);
	    ...
	    private static void AddEquivalent(ExprAggregateNode aggNodeToAdd, IDictionary<ExprAggregateNode, IList<ExprAggregateNode>> equivalencyList)
	    {
	        // Check any same aggregation nodes among all aggregation clauses
	        bool foundEquivalent = false;
            foreach( KeyValuePair<ExprAggregateNode, IList<ExprAggregateNode>> entry in equivalencyList )
	        {
                ExprAggregateNode aggNode = entry.Key;
	            if (ExprNode.DeepEquals(aggNode, aggNodeToAdd))
	            {
	                IList<ExprAggregateNode> equivalentAggregators = entry.Value;
	                if (equivalentAggregators == null)
	                {
