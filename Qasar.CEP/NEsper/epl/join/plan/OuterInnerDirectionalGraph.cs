...
namespace com.espertech.esper.epl.join.plan
{
    ...
    {
        private readonly Map<int, Set<int>> streamToInnerMap;
        ...
        public OuterInnerDirectionalGraph(int numStreams)
        {
            ...
            this.streamToInnerMap = new HashMap<int, Set<int>>();
        }
        ...
        public virtual OuterInnerDirectionalGraph Add(int outerStream, int innerStream)
        {
            ...
            // add set
            Set<int> innerSet = streamToInnerMap.Get( outerStream, null ) ;
            if ( innerSet == null )
            {
        ...
        public Set<int> GetInner(int outerStream)
        {
            ...
            return streamToInnerMap.Get(outerStream, null);
        }
