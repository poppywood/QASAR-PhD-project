...
namespace com.espertech.esper.epl.join.plan
{
    ...
    public class QueryGraph
    {
        ...
        private readonly IDictionary<QueryGraphKey, QueryGraphValue> streamJoinMap;
        ...
        public QueryGraph(int numStreams)
        {
            ...
            this.streamJoinMap = new Dictionary<QueryGraphKey, QueryGraphValue>();
        }
        ...
        public virtual bool Add(int streamLeft, String propertyLeft, int streamRight, String propertyRight)
        {
            ...
            QueryGraphValue _value = null;
            if (!streamJoinMap.TryGetValue(key, out _value))
            {
                _value = new QueryGraphValue();
