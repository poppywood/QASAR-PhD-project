...
{
    /// <summary>
    /// Strategy for use in poll-based joins to reduce a cached result set (represented by <see cref="EventTable"/>), in
	...
	public interface HistoricalIndexLookupStrategy
	{
	    ...
	    IEnumerator<EventBean> Lookup(EventBean lookupEvent, EventTable index);
	}
} // End of namespace
