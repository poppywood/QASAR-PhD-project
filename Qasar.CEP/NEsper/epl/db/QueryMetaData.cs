...
namespace com.espertech.esper.epl.db
{
    ...
    public class QueryMetaData
    {
        ...
        private readonly Map<String, DBOutputTypeDesc> outputParameters;
        ...
        public QueryMetaData(IList<String> inputParameters, Map<String, DBOutputTypeDesc> outputParameters)
        {
        ...
        public Map<String, DBOutputTypeDesc> OutputParameters
        {
