...
namespace com.espertech.esper.epl.expression
{
    ...
    public class ExprStaticMethodNode : ExprNode
    {
        ...
        /// </returns>
        virtual public FastMethod StaticMethod
        {
                                      ...
                                      VariableService variableService)
        {
			...
			try
			{
                MethodInfo methodInfo = methodResolutionService.ResolveMethod(typeName, methodName, paramTypes);
			    FastClass fastClass = FastClass.Create(methodInfo.DeclaringType);
			    staticMethod = fastClass.GetMethod(methodInfo);
			}
			catch(Exception e)
			{
