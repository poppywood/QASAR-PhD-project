...
namespace com.espertech.esper.epl.spec
{
    ...
    public class PluggableObjectCollection
    {
        ...
        private readonly Map<String, Map<String, Pair<Type, PluggableObjectType>>> pluggables;
        ...
        {
            pluggables = new HashMap<String, Map<String, Pair<Type, PluggableObjectType>>>();
        }
        ...
        {
            foreach (
                KeyValuePair<String, Map<String, Pair<Type, PluggableObjectType>>> entry in other.Pluggables)
            {
                Map<String, Pair<Type, PluggableObjectType>> namespaceMap = pluggables.Get(entry.Key);
                if (namespaceMap == null)
                {
                    namespaceMap = new HashMap<String, Pair<Type, PluggableObjectType>>();
        ...
        {
            Map<String, Pair<Type, PluggableObjectType>> namespaceMap = pluggables.Get(_namespace);
            if (namespaceMap == null)
            {
                namespaceMap = new HashMap<String, Pair<Type, PluggableObjectType>>();
        ...
        /// Returns
        public Map<String, Map<String, Pair<Type, PluggableObjectType>>> Pluggables
        {
        ...
        private void InitViews(IEnumerable<ConfigurationPlugInView> configurationPlugInViews)
        {
            ...
            foreach (ConfigurationPlugInView entry in configurationPlugInViews)
            {
                ...
                Map<String, Pair<Type, PluggableObjectType>> namespaceMap = pluggables.Get(entry.Namespace);
                if (namespaceMap == null)
                {
                    namespaceMap = new HashMap<String, Pair<Type, PluggableObjectType>>();
