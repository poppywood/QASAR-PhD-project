...
namespace com.espertech.esper.collection
{
    ...
    public sealed class MultiKey<T> where T : class
	{
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiKey&lt;T&gt;"/> class.
        /// </summary>
        /// <param name="keys">The keys.</param>
        public MultiKey(ICollection<T> keys) : this( CollectionHelper.ToArray( keys ) )
        {
        }
		...
		{
			return "MultiKeyUntyped{{" + CollectionHelper.Render( keys ) + "}}";
		}
	}
}
