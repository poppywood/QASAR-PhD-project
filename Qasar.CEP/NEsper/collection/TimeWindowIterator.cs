...
{
	/// <summary>
    /// Iterator for <see cref="TimeWindow"/> to iterate over a timestamp slots that hold events.
    /// </summary>

    public sealed class TimeWindowIterator : IEnumerator<EventBean>
    {
        private readonly IEnumerator<Pair<Int64, IEnumerable<EventBean>>> keyIterator;
        ...
        public TimeWindowIterator(IEnumerable<Pair<long, IEnumerable<EventBean>>> window)
        {
