...
namespace com.espertech.esper.events.vaevent
{
    ...
    public class VariantSpec
    {
        ...
        private readonly TypeVariance typeVariance;
        ...
        public VariantSpec(String variantStreamName, EventType[] eventTypes, TypeVariance typeVariance)
        {
        ...
        public TypeVariance TypeVariance
        {
