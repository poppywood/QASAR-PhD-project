...
namespace com.espertech.esper.events.xml
{
    ...
    /// (normally via <see cref="com.espertech.esper.events.xml.XPathPropertyGetter"/> ).
    /// 
    /// For "on the fly" property resolvers, use either
    /// <see cref="com.espertech.esper.events.xml.SimpleXMLEventType"/> or
    /// <see cref="com.espertech.esper.events.xml.SchemaXMLEventType"/>
    /// 
    /// </summary>
    /// <author>  pablo
    /// </author>
    ...
    public abstract class BaseXMLEventType : BaseConfigurableEventType
    {
        ...
        public ConfigurationEventTypeXMLDOM ConfigurationEventTypeXMLDOM
        {
            get { return configurationEventTypeXMLDOM; }
        }
        ...
        protected void SetExplicitProperties(ICollection<ConfigurationEventTypeXMLDOM.XPathPropertyDesc> explicitProperties)
        {
            ...
            try
            {
                foreach (ConfigurationEventTypeXMLDOM.XPathPropertyDesc property in explicitProperties)
                {
                    ...
                    getters[property.Name] = new XPathPropertyGetter(property.Name, expression, property.ResultDataType, property.OptionalCastToType);
                }
            }
