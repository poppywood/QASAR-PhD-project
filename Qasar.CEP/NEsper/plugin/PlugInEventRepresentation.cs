...
namespace com.espertech.esper.plugin
{
    ...
    /// (parameters possible) via <see cref="ConfigurationOperations.PlugInEventTypeAliasResolutionURIs"/>.
    /// </para>
    /// <para>
    /// Last, see <see cref="EPRuntime.GetEventSender(IEnumerable{Uri})"/>. An
    ...
    public interface PlugInEventRepresentation
    {
        ...
        /// <summary>
        /// For use with <see cref="EPRuntime.GetEventSender(IEnumerable{Uri})"/>, returns 
        ...
        /// <summary>
        /// For use with <see cref="EPRuntime.GetEventSender(IEnumerable{Uri})"/>, returns
        /// the factory that can inspect event objects and provide an event <see cref="com.espertech.esper.events.EventBean"/> wrapper.
        /// </summary>
