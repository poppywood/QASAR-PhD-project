    ...
    public class ResultSetProcessorFactory
    {
													  ...
													  ViewResourceDelegate viewResourceDelegate)
        {
	        ...
	        if ((groupByNodes.Count == 0) && hasAggregation)
	        {
                ...
                if ((nonAggregatedProps.Count == 0) && (!isUsingWildcard))
	            {
        ...
        private static void ExpandAliases(IList<SelectExprElementRawSpec> selectionList, IList<OrderByItem> orderByList)
        {
