...
namespace net.esper.eql.view
{
    ...
    public class InternalRouteView : ViewSupport
    {
        ...
        /// Ctor.
        /// </summary>
        /// <param name="isStream">true for insert stream, false for remove stream</param>
        /// <param name="internalEventRouter">routes the events internally</param>
        /// <param name="epStatementHandle">The statement handle.</param>
        public InternalRouteView(bool isStream, InternalEventRouter internalEventRouter, EPStatementHandle epStatementHandle)
        {
