...
namespace net.esper.eql.view
{
	...
	public class OutputProcessViewPolicy : OutputProcessView
	{
        ...
        private readonly List<EventBean> newEventsList = new List<EventBean>();
        private readonly List<EventBean> oldEventsList = new List<EventBean>();
        private readonly Set<MultiKey<EventBean>> newEventsSet = new LinkedHashSet<MultiKey<EventBean>>();
        private readonly Set<MultiKey<EventBean>> oldEventsSet = new LinkedHashSet<MultiKey<EventBean>>();
	    ...
	    public OutputProcessViewPolicy(ResultSetProcessor resultSetProcessor,
	        ...
	        : base(resultSetProcessor, streamCount > 1)
	    {
	        log.Debug(".ctor");
            ...
            outputCondition = statementContext.OutputConditionFactory.CreateCondition(outputLimitSpec, statementContext, outputCallback); 
