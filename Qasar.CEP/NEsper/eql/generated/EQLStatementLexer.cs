	...
	public 	class EQLStatementLexer : antlr.CharScanner	, TokenStream
	 {
		...
		private void initialize()
		{
			...
			literals.Add("by", 39);
			literals.Add("millisecond", 191);
			literals.Add("days", 183);
			literals.Add("second", 188);
			literals.Add("all", 43);
			literals.Add("order", 52);
			literals.Add("hour", 186);
			literals.Add("hours", 185);
			literals.Add("pattern", 57);
			literals.Add("lastweekday", 63);
			literals.Add("false", 154);
			literals.Add("exists", 61);
			literals.Add("milliseconds", 190);
			literals.Add("asc", 53);
			literals.Add("minute", 187);
			literals.Add("sec", 189);
			literals.Add("left", 34);
			literals.Add("day", 184);
			literals.Add("weekday", 62);
	...
	public void mWS(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
{
		...
		{ // ( ... )+
			...
			for (;;)
			{
				...
				default:
				{
					if (_cnt294 >= 1) { goto _loop294_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
				}
				break; }
				_cnt294++;
			}
			...
			case 'u':
			{
				{ // ( ... )+
					...
					for (;;)
					{
						...
						{
							if (_cnt316 >= 1) { goto _loop316_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
						}
								...
								try {
									{
										{ // ( ... )+
											...
											for (;;)
											{
												...
												{
													if (_cnt339 >= 1) { goto _loop339_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
												}
...
_loop343_breakloop:									;
								...
								{ // ( ... )+
									...
									for (;;)
									{
										...
										{
											if (_cnt345 >= 1) { goto _loop345_breakloop; } else { throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(), getColumn());; }
										}
