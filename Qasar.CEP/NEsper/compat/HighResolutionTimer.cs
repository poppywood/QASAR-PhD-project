    ...
    public class HighResolutionTimer : ITimer
    {
        ...
        private void Start()
        {
            if (m_dueTime == 0)
            {
                ...
                log.WarnFormat(".Start - Timer#{0}", m_timer);
        ...
        public void Dispose()
        {
            ...
            if (m_timer.HasValue)
            {
                log.WarnFormat(".Dispose - Timer#{0}", m_timer.Value) ;
        ...
        static void OnAppDomainUnload(object sender, EventArgs e)
        {
            ...
            {
                log.Warn(".OnAppDomainUnload - Called; unloading timers");
                ...
                foreach (uint timerId in m_timerTable.Keys)
                {
                    ...
                    log.WarnFormat(".OnAppDomainUnload - KillEvent #{0}", timerId) ;
                }
