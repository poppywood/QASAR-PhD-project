...
namespace com.espertech.esper.compat
{
	...
	public class CollectionHelper
	{
        ...
        public static bool IsEmpty<T>(ICollection<T> anyCollection)
        {
            return anyCollection.Count == 0;
        }
        ...
        public static bool IsNotEmpty<T>(ICollection<T> anyCollection)
        {
            return anyCollection.Count != 0;
        }
