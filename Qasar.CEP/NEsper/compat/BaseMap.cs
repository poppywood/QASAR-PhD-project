...
namespace com.espertech.esper.compat
{
    ...
    [Serializable]
	public class BaseMap<K,V> : Map<K,V>
	{
        ...
        public override bool Equals(object obj)
        {
            ...
            return
            	Object.Equals( m_nullEntry, oMap.m_nullEntry ) &&
            	CollectionHelper.AreEqual( m_subDictionary, oMap.m_subDictionary ) ;
        }
        ...
        public static Map<K,V> AsEDictionary( IDictionary<K,V> sourceDictionary ) {
        	Map<K,V> result = sourceDictionary as Map<K, V>;
            if ( result == null )
            {
