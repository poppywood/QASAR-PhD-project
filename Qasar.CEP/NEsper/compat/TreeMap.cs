...
namespace com.espertech.esper.compat
{
	...
	{
		private readonly C5.TreeDictionary<K, V> m_subDictionary;
		...
		public TreeMap( C5.TreeDictionary<K, V> subDictionary ) {
        ...
        public virtual IEnumerable<KeyValuePair<K,V>> HeadFast(K key)
        {
		...
		public virtual TreeMap<K,V> Tail( K key ) {
            C5.TreeDictionary<K, V> child = new C5.TreeDictionary<K, V>(m_subDictionary.Comparer);
        ...
        public virtual IEnumerable<KeyValuePair<K, V>> TailFast(K key)
        {
		...
		public virtual TreeMap<K,V> Range( K lowerKey, K upperKey ) {
            C5.TreeDictionary<K, V> child = new C5.TreeDictionary<K, V>(m_subDictionary.Comparer);
        ...
        {
            if ((obj == null) || !(obj is TreeMap<K,V>))
            {
                return false;
            }

            TreeMap<K, V> oMap = (TreeMap<K,V>)obj;
            ...
            IEnumerator<C5.KeyValuePair<K, V>> enumB = oMap.m_subDictionary.GetEnumerator();
