...
namespace com.espertech.esper.filter
{
	...
	public abstract class FilterParamIndexBase : EventEvaluator
	{
        ...
        public abstract FastReaderWriterLock ReadWriteLock { get; }
		...
		abstract public void MatchEvent(com.espertech.esper.events.EventBean _event, IList<FilterHandle> matches);
	}
} // End of namespace
