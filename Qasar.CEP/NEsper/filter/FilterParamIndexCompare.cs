...
namespace com.espertech.esper.filter
{
    ...
    {
        private readonly TreeMap<Object, EventEvaluator> constantsMap;
        ...
        {
            constantsMap = new TreeMap<Object, EventEvaluator>(sm_doubleComparer);
        ...
        public override EventEvaluator this[Object filterConstant]
        {
            get
            {
                ...
                return constantsMap.Get(constant, null);
            }
        ...
        public override void MatchEvent(EventBean eventBean, IList<FilterHandle> matches)
        {
            ...
            try
            {
                ...
                {
                    exactEquals = constantsMap.Get(propertyValueDouble);
                }
                ...
                {
                    EventEvaluator matcher = constantsMap.Get(propertyValueDouble);
                    if (matcher != null)
                    {
                        matcher.MatchEvent(eventBean, matches);
                    }
