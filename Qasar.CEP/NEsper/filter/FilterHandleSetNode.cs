...
{
	/// <summary>
	/// This class holds a list of indizes storing filter constants in <see cref="FilterParamIndexBase"/> nodes
	/// and a set of <see cref="FilterHandle"/>.
	...
	public sealed class FilterHandleSetNode : EventEvaluator
	{
        ...
        private readonly FastReaderWriterLock nodeRWLock;
	    ...
	    public FilterHandleSetNode()
	    {
            ...
            nodeRWLock = new FastReaderWriterLock();
        ...
        public FastReaderWriterLock NodeRWLock
	    {
	    ...
	    {
            bool _isDebugEnabled = ExecutionPathDebugLog.isDebugEnabled && this.isDebugEnabled;
