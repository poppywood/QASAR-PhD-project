...
{
	/// <summary>
    /// Utility class for matching filter parameters to indizes. Matches are indicated by the index <see cref="FilterParamIndexBase" />
	/// and the filter parameter <see cref="FilterSpecParam"/> featuring the same event property name and filter operator.
	/// </summary>
