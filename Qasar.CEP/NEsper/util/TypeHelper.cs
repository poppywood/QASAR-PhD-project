...
namespace net.esper.util
{
    ...
    public class TypeHelper
    {
        ...
        private static readonly Type[] s_integralTypes = new Type[]
            {
        ...
        private static readonly Dictionary<Type, int> s_integralTable;
        ...
        static TypeHelper()
        {
            ...
            s_boxedTable[typeof(decimal)] = typeof(decimal?);
            ...
            s_integralTable = new Dictionary<Type, int>();
            for (int ii = 0; ii < s_integralTypes.Length; ii++)
            {
                s_integralTable[s_integralTypes[ii]] = ii;
            }
        }
        ...
        /// </returns>
        public static bool IsIntegral(Type type, Type maxIntegralType)
        {
            int intIndex;
            if (s_integralTable.TryGetValue(type, out intIndex))
            {
                int maxIndex;
                if (s_integralTable.TryGetValue(maxIntegralType, out maxIndex))
                {
        ...
        {
            return s_integralTable.ContainsKey(type);
        }
        ...
        /// </returns>
        public static bool IsIntegralNumber(Object value, Type maxIntegralType)
        {
            return
                (value != null) ?
                (IsIntegral(value.GetType(), maxIntegralType)) :
                (false);
        }
        ...
        public static Object CoerceBoxed(Object numToCoerce, Type resultBoxedType)
        {
            ...
            {
                decimal? value = Convert.ToDecimal(numToCoerce);
                return value;
            }
