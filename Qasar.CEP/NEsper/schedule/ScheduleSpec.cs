...
namespace com.espertech.esper.schedule
{
	...
	public sealed class ScheduleSpec : MetaDefItem
	{
		...
		private readonly Map<ScheduleUnit, TreeSet<Int32>> unitValues;
		...
		public ScheduleSpec( Map<ScheduleUnit, TreeSet<Int32>> unitValues )
		{
			Validate( unitValues );
		...
		public ScheduleSpec()
		{
			unitValues = new HashMap<ScheduleUnit, TreeSet<Int32>>();
		...
		public Map<ScheduleUnit, TreeSet<Int32>> UnitValues
		{
		...
		{
            TreeSet<Int32> _set = unitValues.Get(element, null);
            if ( _set == null )
			{
				_set = new TreeSet<Int32>();
		...
		public override String ToString()
		{
			...
			foreach ( ScheduleUnit element in ScheduleUnit.Values )
			{
				...
				Set<Int32> valueSet = unitValues.Get( element, null ) ;
		...
		public override bool Equals( Object otherObject )
		{
			...
			foreach ( KeyValuePair<ScheduleUnit, TreeSet<Int32>> entry in unitValues )
			{
				Set<Int32> mySet = entry.Value;
				Set<Int32> otherSet = other.unitValues.Get( entry.Key, null ) ;
		...
		/// </param>
		internal static void compress( IDictionary<ScheduleUnit, TreeSet<Int32>> unitValues )
		{
		...
		/// <param name="unitValues">is the set of valid values per unit
		/// </param>
		internal static void Validate( Map<ScheduleUnit, TreeSet<Int32>> unitValues )
		{
			...
			foreach ( ScheduleUnit unit in ScheduleUnit.Values )
			{
				...
				if ( unitValues.Get( unit, null ) == null )
				// Wildcard - no validation for unit
				{
					continue;
				}

				TreeSet<Int32> values = unitValues.Get( unit, null );
