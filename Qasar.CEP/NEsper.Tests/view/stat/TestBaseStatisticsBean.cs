...
namespace net.esper.view.stat
{
    ...
    public class TestBaseStatisticsBean
    {
        ...
        [Test]
        public virtual void testAddRemoveXOnly()
        {
        ...
        [Test]
        public virtual void testAverage()
        {
            BaseStatisticsBean stat = new BaseStatisticsBean();
        ...
        [Test]
        public virtual void testStddev_STDEVPA()
        {
            BaseStatisticsBean stat = new BaseStatisticsBean();
        ...
        [Test]
        public virtual void testStddevAndVariance_STDEV()
        {
            BaseStatisticsBean stat = new BaseStatisticsBean();
