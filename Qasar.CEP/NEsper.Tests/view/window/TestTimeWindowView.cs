...
namespace net.esper.view.window
{
	...
	public class TestTimeWindowView
	{
	    ...
	    public void testViewPushAndExpire()
	    {
	        ...
	        Assert.IsTrue(schedulingServiceStub.GetAdded().Get(TEST_WINDOW_MSEC) != null);
	        ...
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("a1"), events.Get("b1"), events.Get("b2") });
	        SupportViewDataChecker.CheckOldData(childView,null);
	        ...
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("a1"), events.Get("b1"), events.Get("b2"), events.Get("c1") });
	        SupportViewDataChecker.CheckOldData(childView,null);
	        ...
	        myView.Expire();
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("b1"), events.Get("b2"), events.Get("c1") });
	        SupportViewDataChecker.CheckOldData(childView,new EventBean[]{ events.Get("a1") });
	        SupportViewDataChecker.CheckNewData(childView, null);

	        Assert.IsTrue(schedulingServiceStub.GetAdded().Count == 1);
	        Assert.IsTrue(schedulingServiceStub.GetAdded().Get(10000L) != null);
	        schedulingServiceStub.GetAdded().Clear();
	        ...
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("b1"), events.Get("b2"), events.Get("c1"), events.Get("d1"), events.Get("e1") } );
	        ...
	        SupportViewDataChecker.CheckNewData(childView, null);
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("c1"), events.Get("d1"), events.Get("e1") } );

	        Assert.IsTrue(schedulingServiceStub.GetAdded().Count == 1);
	        Assert.IsTrue(schedulingServiceStub.GetAdded().Get(49999L) != null);
	        schedulingServiceStub.GetAdded().Clear();
	        ...
	        SupportViewDataChecker.CheckNewData(childView, null);
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("d1"), events.Get("e1") });

	        Assert.IsTrue(schedulingServiceStub.GetAdded().Count == 1);
	        Assert.IsTrue(schedulingServiceStub.GetAdded().Get(1L) != null);
	        schedulingServiceStub.GetAdded().Clear();
	        ...
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("d1"), events.Get("e1"), events.Get("f1"), events.Get("f2") });
	        ...
	        SupportViewDataChecker.CheckNewData(childView, null);
	        ArrayAssertionUtil.AreEqualExactOrder(myView.GetEnumerator(),new EventBean[]{ events.Get("f1"), events.Get("f2") } );

	        Assert.IsTrue(schedulingServiceStub.GetAdded().Count == 1);
	        Assert.IsTrue(schedulingServiceStub.GetAdded().Get(101L) != null);
	        schedulingServiceStub.GetAdded().Clear();
