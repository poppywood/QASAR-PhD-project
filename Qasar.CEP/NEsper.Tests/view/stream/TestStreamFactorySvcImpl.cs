...
namespace net.esper.view.stream
{
	...
	public class TestStreamFactorySvcImpl
	{
	    ...
	    public void testInvalidJoin()
	    {
            ...
            streams[0] = streamFactoryService.CreateStream(filterSpecs[0], supportFilterService, null, true).First;
	    ...
	    public void testCreateJoin()
	    {
	        streams = new EventStream[3];
            streams[0] = streamFactoryService.CreateStream(filterSpecs[0], supportFilterService, null, true).First;
            streams[1] = streamFactoryService.CreateStream(filterSpecs[1], supportFilterService, null, true).First;
            streams[2] = streamFactoryService.CreateStream(filterSpecs[2], supportFilterService, null, true).First;
	    ...
	    public void testCreateNoJoin()
	    {
            ...
            streams[0] = streamFactoryService.CreateStream(filterSpecs[0], supportFilterService, stmtHande, false).First;
            streams[1] = streamFactoryService.CreateStream(filterSpecs[0], supportFilterService, stmtHande, false).First;
            streams[2] = streamFactoryService.CreateStream(filterSpecs[1], supportFilterService, stmtHande, false).First;
            streams[3] = streamFactoryService.CreateStream(filterSpecs[2], supportFilterService, stmtHande, false).First;
