...
namespace net.esper.eql.core
{
	...
	public class TestSelectExprEvalProcessor
	{
	    ...
	    public void testGetResultEventType()
	    {
            ...
            ArrayAssertionUtil.AreEqualAnyOrder(type.PropertyNames, new String[] { "resultOne", "resultTwo" });
	        ...
	        ArrayAssertionUtil.AreEqualAnyOrder(type.PropertyNames, new String[] {"a", "b"});
