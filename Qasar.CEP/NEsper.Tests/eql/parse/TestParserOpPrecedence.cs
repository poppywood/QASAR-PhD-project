...
namespace net.esper.eql.parse
{
	...
	{
		[Test]
		public virtual void  testEquivalency()
		{
			assertEquivalent("every a()", "(every a())");
			
			assertEquivalent("every a() or b()", "((every a()) or b())");
			
			assertEquivalent("every a() -> b() or c()", "(every a()) -> (b() or c())");
			
			assertEquivalent("every a() -> b() and c()", "(every a()) -> (b() and c())");
			
			assertEquivalent("a() and b() or c()", "(a() and b()) or c()");
			
			assertEquivalent("a() or b() and c() or d()", "a() or (b() and c()) or d()");
			
			assertEquivalent("a() or b() and every e() -> f() -> c() or d()", "(a() or (b() and (every (e())))) -> f() -> (c() or d())");
			
			assertEquivalent("a() -> b() or e() -> f()", "a() -> (b() or e()) -> f()");
			
			String original = "every a() -> every b() and c() or d() and not e() -> f()";
			assertEquivalent(original, "every a() -> (every b()) and c() or d() and (not (e())) -> f()");
			assertEquivalent(original, "(every a()) -> ((every b()) and c()) or (d() and (not (e()))) -> f()");
			
			assertEquivalent("not a()", "(not a())");
			
			assertEquivalent("every a() where timer:within(5)", "every (a() where timer:within(5))");
			
			original = "every a() where timer:within(5) and not b() where timer:within(3) -> d() where timer:within(4)";
			assertEquivalent(original, "every (a() where timer:within(5)) and not (b() where timer:within(3)) -> (d() where timer:within(4))");
			assertEquivalent(original, "(every (a() where timer:within(5))) and (not (b() where timer:within(3))) -> (d() where timer:within(4))");
			assertEquivalent(original, "((every (a() where timer:within(5))) and (not (b() where timer:within(3)))) -> (d() where timer:within(4))");
			
			assertEquivalent("((a() where timer:within(10)) or (b() where timer:within(5))) where timer:within(20)", "(a() where timer:within(10) or b() where timer:within(5)) where timer:within(20)");
		...
		[Test]
		public virtual void  testNotEquivalent()
		{
		...
		private void  assertEquivalent(String expressionOne, String expressionTwo)
		{
			...
			Assert.IsTrue(astOne.EqualsTree(astTwo));
		}
		...
		private void  assertNotEquivalent(String expressionOne, String expressionTwo)
		{
			...
			Assert.IsFalse(astOne.EqualsTree(astTwo));
		}
