...
namespace net.esper.eql.db
{
	...
	{
	    private readonly IList<EventBean>[] lists = new IList<EventBean>[10];
	    ...
	    public void testPurgeInterval()
	    {
	        ...
	        DataCacheExpiringImpl cache = new DataCacheExpiringImpl(10, 20, scheduler, null, null);   // age 10 sec, purge 1000 seconds
	    ...
	    public void testGet()
	    {
	        SupportSchedulingServiceImpl scheduler = new SupportSchedulingServiceImpl();
	        DataCacheExpiringImpl cache = new DataCacheExpiringImpl(10, 1000, scheduler, null, null);   // age 10 sec, purge 1000 seconds
