...
namespace net.esper.events
{
	...
	public class TestWrapperEventType
	{
		...
		{
            underlyingEventTypeOne = new BeanEventType(typeof(SupportBeanSimple), new BeanEventAdapter(new HashDictionary<Type, BeanEventType>()), null, "abc");
            underlyingEventTypeTwo = new BeanEventType(typeof(SupportBean_A), new BeanEventAdapter(new HashDictionary<Type, BeanEventType>()), null, "abc");
