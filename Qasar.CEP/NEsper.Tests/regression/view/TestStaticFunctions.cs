...
namespace net.esper.regression.view
{
	...
	public class TestStaticFunctions
	{
		...
		{
            statementText = "select net.esper.support.util.BitWriter.Write(7) " + stream;
            Object[] result = CreateStatementAndGetProperty(true, "net.esper.support.util.BitWriter.Write(7)");
            Assert.AreEqual(BitWriter.Write(7), result[0]);
		...
		public void testTwoParameters()
		{
			...
			statementText = "select Int64.Parse(\"123\")" + stream;
			Object expected = Int64.Parse("123");
            Assert.AreEqual(expected, CreateStatementAndGetProperty(true, "Int64.Parse(\"123\")")[0]);
		}
		...
		public void testMultipleMethodInvocations()
		{
			...
			Object[] props = CreateStatementAndGetProperty(true, "Math.Max(2, price)", "Math.Max(volume, 4)");
