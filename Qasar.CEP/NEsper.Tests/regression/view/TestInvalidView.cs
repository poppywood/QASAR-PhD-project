...
namespace net.esper.regression.view
{
	...
	public class TestInvalidView
	{
	    ...
	    public void testStatementException()
	    {
	        ...
	        // method not found
	        exceptionText = GetStatementExceptionView("select System.Math.UnknownMethod() from " + _event_NUM + ".win:length(10)");
            Assert.AreEqual("Error starting view: Could not find method named 'UnknownMethod' in class 'System.Math'  [select System.Math.UnknownMethod() from net.esper.support.bean.SupportBean_N.win:length(10)]", exceptionText);
