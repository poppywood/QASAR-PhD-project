...
namespace net.esper.regression.db
{
	...
	public class TestDatabaseJoin
	{
	    ...
	    public void SetUp()
	    {
	        ConfigurationDBRef configDB = SupportDatabaseService.MakeConfigurationDB1();
