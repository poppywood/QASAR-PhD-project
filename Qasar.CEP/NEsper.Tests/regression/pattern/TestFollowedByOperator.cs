...
namespace net.esper.regression.pattern
{
	...
	public class TestFollowedByOperator : SupportBeanConstants
	{
	    ...
	    public void testFollowedNotEvery()
	    {
            ...
            EPServiceProvider epService = EPServiceProviderManager.GetDefaultProvider(SupportConfigFactory.Configuration); 
            epService.Initialize();
	        epService.EPRuntime.SendEvent(new TimerControlEvent(TimerControlEvent.ClockTypeEnum.CLOCK_EXTERNAL));
	    ...
	    {
            DateTime dateTime = DateTime.ParseExact(dateText, "yyyy-MM-dd HH:mm:ss.FFF", System.Globalization.CultureInfo.InvariantCulture);
