	...
	public class TestInvalidSyntaxMsg
	{
	    ...
	    public void testSyntaxError()
	    {
	        ...
	        TryCompile("select * from pattern[A -> B - C]",
	                   "unexpected token: [\"B\",<158>,line=1,col=28] near line 1, column 28 [select * from pattern[A -> B - C]]");
	        ...
	        TryCompile("select * from A, into",
	                   "unexpected token: [\"into\",<51>,line=1,col=18] near line 1, column 18 [select * from A, into]");
