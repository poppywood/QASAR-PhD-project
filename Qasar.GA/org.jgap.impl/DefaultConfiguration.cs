...
namespace org.jgap.impl
{
	...
	/// <summary> The DefaultConfiguration class simplifies the JGAP configuration
	...
	{
		/// <summary> Constructs a new DefaultConfiguration instance with a number of
		...
		/// </summary>
		public DefaultConfiguration():base()
		{
			
			try
			{
				addNaturalSelector(new BestChromosomesSelector(), false);
			...
			{
				throw new System.SystemException("Fatal error: DefaultConfiguration class could not use its " + "own stock configuration values. This should never happen. " + "Please report this as a bug to the JGAP team.");
			}
		}
	}
}