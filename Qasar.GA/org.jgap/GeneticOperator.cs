...
namespace org.jgap
{
	...
	/// <summary> A GeneticOperator represents an operation that takes place on
	...
	public interface GeneticOperator
		{
			...
			void  operate(Configuration a_activeConfiguration, Chromosome[] a_population, SupportClass.ListCollectionSupport a_candidateChromosomes);
		}
}