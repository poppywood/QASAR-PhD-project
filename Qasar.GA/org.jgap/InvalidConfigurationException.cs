...
namespace org.jgap
{
	...
	/// <summary> This exception is typically thrown when an invalid value has been
	...
	{
		/// <summary> Constructs a new InvalidConfigurationException instance with the
		/// given error message.
		/// 
		/// </summary>
		...
		/// is being thrown.
		/// </param>
		public InvalidConfigurationException(System.String a_message):base(a_message)
		{
		}
	}
}